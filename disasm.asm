00000000  66BC00700000      mov esp,0x7000
00000006  88165F7D          mov [0x7d5f],dl
0000000A  BB827C            mov bx,0x7c82
0000000D  E86F01            call 0x17f
00000010  FC                cld
00000011  B402              mov ah,0x2
00000013  B500              mov ch,0x0
00000015  B102              mov cl,0x2
00000017  B600              mov dh,0x0
00000019  B011              mov al,0x11
0000001B  31DB              xor bx,bx
0000001D  8EC3              mov es,bx
0000001F  BB007E            mov bx,0x7e00
00000022  CD13              int 0x13
00000024  FD                std
00000025  BB007E            mov bx,0x7e00
00000028  81FB00A6          cmp bx,0xa600
0000002C  7446              jz 0x74
0000002E  BEB67C            mov si,0x7cb6
00000031  89DF              mov di,bx
00000033  4F                dec di
00000034  4E                dec si
00000035  47                inc di
00000036  46                inc si
00000037  8A04              mov al,[si]
00000039  3805              cmp [di],al
0000003B  7506              jnz 0x43
0000003D  3C00              cmp al,0x0
0000003F  75F4              jnz 0x35
00000041  EB05              jmp short 0x48
00000043  83C314            add bx,byte +0x14
00000046  EBE0              jmp short 0x28
00000048  53                push bx
00000049  BB477D            mov bx,0x7d47
0000004C  E83001            call 0x17f
0000004F  5B                pop bx
00000050  83C310            add bx,byte +0x10
00000053  FC                cld
00000054  B402              mov ah,0x2
00000056  8A2F              mov ch,[bx]
00000058  8A4F01            mov cl,[bx+0x1]
0000005B  8A7702            mov dh,[bx+0x2]
0000005E  8A4703            mov al,[bx+0x3]
00000061  31DB              xor bx,bx
00000063  8EC3              mov es,bx
00000065  8EDB              mov ds,bx
00000067  BB01A6            mov bx,0xa601
0000006A  8A165F7D          mov dl,[0x7d5f]
0000006E  CD13              int 0x13
00000070  FD                std
00000071  E98D29            jmp 0x2a01
00000074  BBC67C            mov bx,0x7cc6
00000077  E8E600            call 0x160
0000007A  EBFE              jmp short 0x7a
0000007C  68656C            push word 0x6c65
0000007F  6C                insb
00000080  6F                outsw
00000081  004174            add [bx+di+0x74],al
00000084  7465              jz 0xeb
00000086  6D                insw
00000087  7074              jo 0xfd
00000089  696E672074        imul bp,[bp+0x67],word 0x7420
0000008E  6F                outsw
0000008F  206669            and [bp+0x69],ah
00000092  6E                outsb
00000093  64204D61          and [fs:di+0x61],cl
00000097  696E205379        imul bp,[bp+0x20],word 0x7953
0000009C  7374              jnc 0x112
0000009E  656D              gs insw
000000A0  204669            and [bp+0x69],al
000000A3  6C                insb
000000A4  65206F6E          and [gs:bx+0x6e],ch
000000A8  20626F            and [bp+si+0x6f],ah
000000AB  6F                outsw
000000AC  7420              jz 0xce
000000AE  6469736B2E2E      imul si,[fs:bp+di+0x6b],word 0x2e2e
000000B4  2E005359          add [cs:bp+di+0x59],dl
000000B8  53                push bx
000000B9  31434F            xor [bp+di+0x4f],ax
000000BC  52                push dx
000000BD  45                inc bp
000000BE  2020              and [bx+si],ah
000000C0  2020              and [bx+si],ah
000000C2  2020              and [bx+si],ah
000000C4  2000              and [bx+si],al
000000C6  46                inc si
000000C7  41                inc cx
000000C8  54                push sp
000000C9  41                inc cx
000000CA  4C                dec sp
000000CB  20424F            and [bp+si+0x4f],al
000000CE  4F                dec di
000000CF  54                push sp
000000D0  4C                dec sp
000000D1  4F                dec di
...
000000D4  45                inc bp
000000D5  52                push dx
000000D6  204552            and [di+0x52],al
000000D9  52                push dx
000000DA  4F                dec di
000000DB  52                push dx
000000DC  210D              and [di],cx
000000DE  0A4D41            or cl,[di+0x41]
000000E1  49                dec cx
000000E2  4E                dec si
000000E3  205359            and [bp+di+0x59],dl
000000E6  53                push bx
000000E7  54                push sp
000000E8  45                inc bp
000000E9  4D                dec bp
000000EA  204649            and [bp+0x49],al
000000ED  4C                dec sp
000000EE  45                inc bp
000000EF  204E4F            and [bp+0x4f],cl
000000F2  54                push sp
000000F3  20464F            and [bp+0x4f],al
000000F6  55                push bp
000000F7  4E                dec si
000000F8  44                inc sp
000000F9  0D0A46            or ax,0x460a
000000FC  53                push bx
000000FD  204953            and [bx+di+0x53],cl
00000100  20434F            and [bp+di+0x4f],al
00000103  52                push dx
00000104  52                push dx
00000105  55                push bp
00000106  50                push ax
...
00000108  45                inc bp
00000109  44                inc sp
0000010A  204F52            and [bx+0x52],cl
0000010D  205359            and [bp+di+0x59],dl
00000110  53                push bx
00000111  54                push sp
00000112  45                inc bp
00000113  4D                dec bp
00000114  204649            and [bp+0x49],al
00000117  4C                dec sp
00000118  45                inc bp
00000119  20504F            and [bx+si+0x4f],dl
0000011C  49                dec cx
0000011D  4E                dec si
0000011E  54                push sp
0000011F  45                inc bp
00000120  52                push dx
00000121  20504F            and [bx+si+0x4f],dl
00000124  49                dec cx
00000125  4E                dec si
00000126  54                push sp
00000127  53                push bx
00000128  20544F            and [si+0x4f],dl
0000012B  204120            and [bx+di+0x20],al
0000012E  46                inc si
0000012F  49                dec cx
00000130  4C                dec sp
00000131  45                inc bp
00000132  205448            and [si+0x48],dl
00000135  41                inc cx
00000136  54                push sp
00000137  20444F            and [si+0x4f],al
0000013A  45                inc bp
0000013B  53                push bx
0000013C  204E4F            and [bp+0x4f],cl
0000013F  54                push sp
00000140  204558            and [di+0x58],al
00000143  49                dec cx
00000144  53                push bx
00000145  54                push sp
00000146  004D61            add [di+0x61],cl
00000149  696E205379        imul bp,[bp+0x20],word 0x7953
0000014E  7374              jnc 0x1c4
00000150  656D              gs insw
00000152  204669            and [bp+0x69],al
00000155  6C                insb
00000156  6520666F          and [gs:bp+0x6f],ah
0000015A  756E              jnz 0x1ca
0000015C  642100            and [fs:bx+si],ax
0000015F  00608A            add [bx+si-0x76],ah
00000162  07                pop es
00000163  3C00              cmp al,0x0
00000165  7409              jz 0x170
00000167  B40E              mov ah,0xe
00000169  CD10              int 0x10
0000016B  83C301            add bx,byte +0x1
0000016E  EBF1              jmp short 0x161
00000170  61                popa
00000171  C3                ret
00000172  60                pusha
00000173  B40E              mov ah,0xe
00000175  B00A              mov al,0xa
00000177  CD10              int 0x10
00000179  B00D              mov al,0xd
0000017B  CD10              int 0x10
0000017D  61                popa
0000017E  C3                ret
0000017F  E8DEFF            call 0x160
00000182  E8EDFF            call 0x172
00000185  C3                ret
...
0000020A  45                inc bp
0000020B  52                push dx
0000020C  312E3000          xor [0x30],bp
00000210  0000              add [bx+si],al
00000212  0000              add [bx+si],al
00000214  53                push bx
00000215  59                pop cx
00000216  53                push bx
00000217  30424F            xor [bp+si+0x4f],al
0000021A  4F                dec di
0000021B  54                push sp
0000021C  2020              and [bx+si],ah
0000021E  2020              and [bx+si],ah
00000220  2020              and [bx+si],ah
00000222  2000              and [bx+si],al
00000224  0001              add [bx+di],al
00000226  0001              add [bx+di],al
00000228  53                push bx
00000229  59                pop cx
0000022A  53                push bx
0000022B  31434F            xor [bp+di+0x4f],ax
0000022E  52                push dx
0000022F  45                inc bp
00000230  2020              and [bx+si],ah
00000232  2020              and [bx+si],ah
00000234  2020              and [bx+si],ah
00000236  2000              and [bx+si],al
00000238  0001              add [bx+di],al
0000023A  010A              add [bp+si],cx
...
00002400  E82A05            call 0x292d
00002403  F4                hlt
00002404  F30F1EFB          endbr32
00002408  6655              push ebp
0000240A  6689E5            mov ebp,esp
0000240D  6656              push esi
0000240F  6653              push ebx
00002411  6683EC10          sub esp,byte +0x10
00002415  67C745F60000      mov word [ebp-0xa],0x0
0000241B  E98100            jmp 0x249f
0000241E  67C745F40000      mov word [ebp-0xc],0x0
00002424  EB5F              jmp short 0x2485
00002426  660FB606E6A5      movzx eax,byte [0xa5e6]
0000242C  660FB6D0          movzx edx,al
00002430  660FB606F0A5      movzx eax,byte [0xa5f0]
00002436  660FB6C0          movzx eax,al
0000243A  66E8C9000000      call dword 0x2509
00002440  660FB6D8          movzx ebx,al
00002444  668B36E0A5        mov esi,[0xa5e0]
00002449  67660FB755F6      movzx edx,word [ebp-0xa]
0000244F  67660FB745F4      movzx eax,word [ebp-0xc]
00002455  66E85E020000      call dword 0x26b9
0000245B  660FB7C0          movzx eax,ax
0000245F  6601C0            add eax,eax
00002462  6601C6            add esi,eax
00002465  6689DA            mov edx,ebx
00002468  66B820000000      mov eax,0x20
0000246E  66E8CD000000      call dword 0x2541
00002474  678906            mov [esi],ax
00002477  67660FB745F4      movzx eax,word [ebp-0xc]
0000247D  6683C001          add eax,byte +0x1
00002481  678945F4          mov [ebp-0xc],ax
00002485  660FB706F4A5      movzx eax,word [0xa5f4]
0000248B  673945F4          cmp [ebp-0xc],ax
0000248F  7295              jc 0x2426
00002491  67660FB745F6      movzx eax,word [ebp-0xa]
00002497  6683C001          add eax,byte +0x1
0000249B  678945F6          mov [ebp-0xa],ax
0000249F  660FB706F2A5      movzx eax,word [0xa5f2]
000024A5  673945F6          cmp [ebp-0xa],ax
000024A9  0F8271FF          jc near 0x241e
000024AD  C706E4A50000      mov word [0xa5e4],0x0
000024B3  C706E8A50000      mov word [0xa5e8],0x0
000024B9  90                nop
000024BA  6683C410          add esp,byte +0x10
000024BE  665B              pop ebx
000024C0  665E              pop esi
000024C2  665D              pop ebp
000024C4  66C3              retd
000024C6  F30F1EFB          endbr32
000024CA  6655              push ebp
000024CC  6689E5            mov ebp,esp
000024CF  6683EC08          sub esp,byte +0x8
000024D3  C606E6A500        mov byte [0xa5e6],0x0
000024D8  C606F0A50F        mov byte [0xa5f0],0xf
000024DD  C706F2A51900      mov word [0xa5f2],0x19
000024E3  C706F4A55000      mov word [0xa5f4],0x50
000024E9  C706E8A50000      mov word [0xa5e8],0x0
000024EF  C706E4A50000      mov word [0xa5e4],0x0
000024F5  66C706E0A500800B  mov dword [0xa5e0],0xb8000
         -00
000024FE  66E800FFFFFF      call dword 0x2404
00002504  90                nop
00002505  66C9              o32 leave
00002507  66C3              retd
00002509  F30F1EFB          endbr32
0000250D  6655              push ebp
0000250F  6689E5            mov ebp,esp
00002512  6683EC08          sub esp,byte +0x8
00002516  6689C1            mov ecx,eax
00002519  6689D0            mov eax,edx
0000251C  6689CA            mov edx,ecx
0000251F  678855FC          mov [ebp-0x4],dl
00002523  678845F8          mov [ebp-0x8],al
00002527  67660FB645F8      movzx eax,byte [ebp-0x8]
0000252D  66C1E004          shl eax,byte 0x4
00002531  6689C2            mov edx,eax
00002534  67660FB645FC      movzx eax,byte [ebp-0x4]
0000253A  6609D0            or eax,edx
0000253D  66C9              o32 leave
0000253F  66C3              retd
00002541  F30F1EFB          endbr32
00002545  6655              push ebp
00002547  6689E5            mov ebp,esp
0000254A  6683EC08          sub esp,byte +0x8
0000254E  6689C1            mov ecx,eax
00002551  6689D0            mov eax,edx
00002554  6689CA            mov edx,ecx
00002557  678855FC          mov [ebp-0x4],dl
0000255B  678845F8          mov [ebp-0x8],al
0000255F  67660FB645FC      movzx eax,byte [ebp-0x4]
00002565  67660FB655F8      movzx edx,byte [ebp-0x8]
0000256B  66C1E208          shl edx,byte 0x8
0000256F  6609D0            or eax,edx
00002572  66C9              o32 leave
00002574  66C3              retd
00002576  F30F1EFB          endbr32
0000257A  6655              push ebp
0000257C  6689E5            mov ebp,esp
0000257F  6683EC28          sub esp,byte +0x28
00002583  67668945DC        mov [ebp-0x24],eax
00002588  67668955D8        mov [ebp-0x28],edx
0000258D  6766C745ED303132  mov dword [ebp-0x13],0x33323130
         -33
00002596  6766C745F1343536  mov dword [ebp-0xf],0x37363534
         -37
0000259F  67C745F53839      mov word [ebp-0xb],0x3938
000025A5  67C645F700        mov byte [ebp-0x9],0x0
000025AA  67668B45D8        mov eax,[ebp-0x28]
000025AF  67668945FC        mov [ebp-0x4],eax
000025B4  6766837DDC00      cmp dword [ebp-0x24],byte +0x0
000025BA  7918              jns 0x25d4
000025BC  67668B45FC        mov eax,[ebp-0x4]
000025C1  67668D5001        lea edx,[eax+0x1]
000025C6  67668955FC        mov [ebp-0x4],edx
000025CB  67C6002D          mov byte [eax],0x2d
000025CF  6766F75DDC        neg dword [ebp-0x24]
000025D4  67668B45DC        mov eax,[ebp-0x24]
000025D9  67668945F8        mov [ebp-0x8],eax
000025DE  67668345FC01      add dword [ebp-0x4],byte +0x1
000025E4  67668B4DF8        mov ecx,[ebp-0x8]
000025E9  66BA67666666      mov edx,0x66666667
000025EF  6689C8            mov eax,ecx
000025F2  66F7EA            imul edx
000025F5  66C1FA02          sar edx,byte 0x2
000025F9  6689C8            mov eax,ecx
000025FC  66C1F81F          sar eax,byte 0x1f
00002600  6629C2            sub edx,eax
00002603  6689D0            mov eax,edx
00002606  67668945F8        mov [ebp-0x8],eax
0000260B  6766837DF800      cmp dword [ebp-0x8],byte +0x0
00002611  75CB              jnz 0x25de
00002613  67668B45FC        mov eax,[ebp-0x4]
00002618  67C60000          mov byte [eax],0x0
0000261C  67668B4DDC        mov ecx,[ebp-0x24]
00002621  66BA67666666      mov edx,0x66666667
00002627  6689C8            mov eax,ecx
0000262A  66F7EA            imul edx
0000262D  66C1FA02          sar edx,byte 0x2
00002631  6689C8            mov eax,ecx
00002634  66C1F81F          sar eax,byte 0x1f
00002638  6629C2            sub edx,eax
0000263B  6689D0            mov eax,edx
0000263E  66C1E002          shl eax,byte 0x2
00002642  6601D0            add eax,edx
00002645  6601C0            add eax,eax
00002648  6629C1            sub ecx,eax
0000264B  6689CA            mov edx,ecx
0000264E  6766836DFC01      sub dword [ebp-0x4],byte +0x1
00002654  67660FB65415ED    movzx edx,byte [dword ebp+edx-0x13]
0000265B  67668B45FC        mov eax,[ebp-0x4]
00002660  678810            mov [eax],dl
00002663  67668B4DDC        mov ecx,[ebp-0x24]
00002668  66BA67666666      mov edx,0x66666667
0000266E  6689C8            mov eax,ecx
00002671  66F7EA            imul edx
00002674  66C1FA02          sar edx,byte 0x2
00002678  6689C8            mov eax,ecx
0000267B  66C1F81F          sar eax,byte 0x1f
0000267F  6629C2            sub edx,eax
00002682  6689D0            mov eax,edx
00002685  67668945DC        mov [ebp-0x24],eax
0000268A  6766837DDC00      cmp dword [ebp-0x24],byte +0x0
00002690  758A              jnz 0x261c
00002692  67668B45D8        mov eax,[ebp-0x28]
00002697  66C9              o32 leave
00002699  66C3              retd
0000269B  F30F1EFB          endbr32
0000269F  6655              push ebp
000026A1  6689E5            mov ebp,esp
000026A4  6683EC08          sub esp,byte +0x8
000026A8  66B858000000      mov eax,0x58
000026AE  66E83E000000      call dword 0x26f2
000026B4  90                nop
000026B5  66C9              o32 leave
000026B7  66C3              retd
000026B9  F30F1EFB          endbr32
000026BD  6655              push ebp
000026BF  6689E5            mov ebp,esp
000026C2  6683EC08          sub esp,byte +0x8
000026C6  6689C1            mov ecx,eax
000026C9  6689D0            mov eax,edx
000026CC  6689CA            mov edx,ecx
000026CF  678955FC          mov [ebp-0x4],dx
000026D3  678945F8          mov [ebp-0x8],ax
000026D7  660FB706F4A5      movzx eax,word [0xa5f4]
000026DD  670FAF45F8        imul ax,[ebp-0x8]
000026E2  6689C2            mov edx,eax
000026E5  67660FB745FC      movzx eax,word [ebp-0x4]
000026EB  6601D0            add eax,edx
000026EE  66C9              o32 leave
000026F0  66C3              retd
000026F2  F30F1EFB          endbr32
000026F6  6655              push ebp
000026F8  6689E5            mov ebp,esp
000026FB  6657              push edi
000026FD  6656              push esi
000026FF  6653              push ebx
00002701  6683EC04          sub esp,byte +0x4
00002705  678845F0          mov [ebp-0x10],al
00002709  67807DF00A        cmp byte [ebp-0x10],0xa
0000270E  752F              jnz 0x273f
00002710  C706E4A50000      mov word [0xa5e4],0x0
00002716  660FB716E8A5      movzx edx,word [0xa5e8]
0000271C  660FB706F2A5      movzx eax,word [0xa5f2]
00002722  39C2              cmp dx,ax
00002724  7509              jnz 0x272f
00002726  C706E8A50000      mov word [0xa5e8],0x0
0000272C  E9CA00            jmp 0x27f9
0000272F  660FB706E8A5      movzx eax,word [0xa5e8]
00002735  6683C001          add eax,byte +0x1
00002739  A3E8A5            mov [0xa5e8],ax
0000273C  E9BA00            jmp 0x27f9
0000273F  67807DF00D        cmp byte [ebp-0x10],0xd
00002744  7509              jnz 0x274f
00002746  C706E4A50000      mov word [0xa5e4],0x0
0000274C  E9AA00            jmp 0x27f9
0000274F  660FB606E6A5      movzx eax,byte [0xa5e6]
00002755  660FB6D0          movzx edx,al
00002759  660FB606F0A5      movzx eax,byte [0xa5f0]
0000275F  660FB6C0          movzx eax,al
00002763  66E8A0FDFFFF      call dword 0x2509
00002769  660FB6F0          movzx esi,al
0000276D  67660FB645F0      movzx eax,byte [ebp-0x10]
00002773  660FB6D8          movzx ebx,al
00002777  668B3EE0A5        mov edi,[0xa5e0]
0000277C  660FB706E8A5      movzx eax,word [0xa5e8]
00002782  660FB7D0          movzx edx,ax
00002786  660FB706E4A5      movzx eax,word [0xa5e4]
0000278C  660FB7C0          movzx eax,ax
00002790  66E823FFFFFF      call dword 0x26b9
00002796  660FB7C0          movzx eax,ax
0000279A  6601C0            add eax,eax
0000279D  6601C7            add edi,eax
000027A0  6689F2            mov edx,esi
000027A3  6689D8            mov eax,ebx
000027A6  66E895FDFFFF      call dword 0x2541
000027AC  678907            mov [edi],ax
000027AF  660FB716E4A5      movzx edx,word [0xa5e4]
000027B5  660FB706F4A5      movzx eax,word [0xa5f4]
000027BB  39C2              cmp dx,ax
000027BD  752D              jnz 0x27ec
000027BF  C706E4A50000      mov word [0xa5e4],0x0
000027C5  660FB716E8A5      movzx edx,word [0xa5e8]
000027CB  660FB706F2A5      movzx eax,word [0xa5f2]
000027D1  39C2              cmp dx,ax
000027D3  7508              jnz 0x27dd
000027D5  C706E8A50000      mov word [0xa5e8],0x0
000027DB  EB1C              jmp short 0x27f9
000027DD  660FB706E8A5      movzx eax,word [0xa5e8]
000027E3  6683C001          add eax,byte +0x1
000027E7  A3E8A5            mov [0xa5e8],ax
000027EA  EB0D              jmp short 0x27f9
000027EC  660FB706E4A5      movzx eax,word [0xa5e4]
000027F2  6683C001          add eax,byte +0x1
000027F6  A3E4A5            mov [0xa5e4],ax
000027F9  6683C404          add esp,byte +0x4
000027FD  665B              pop ebx
000027FF  665E              pop esi
00002801  665F              pop edi
00002803  665D              pop ebp
00002805  66C3              retd
00002807  F30F1EFB          endbr32
0000280B  6655              push ebp
0000280D  6689E5            mov ebp,esp
00002810  6683EC14          sub esp,byte +0x14
00002814  67668945EC        mov [ebp-0x14],eax
00002819  67C745FE0000      mov word [ebp-0x2],0x0
0000281F  EB0E              jmp short 0x282f
00002821  67660FB745FE      movzx eax,word [ebp-0x2]
00002827  6683C001          add eax,byte +0x1
0000282B  678945FE          mov [ebp-0x2],ax
0000282F  67660FB755FE      movzx edx,word [ebp-0x2]
00002835  67668B45EC        mov eax,[ebp-0x14]
0000283A  6601D0            add eax,edx
0000283D  67660FB600        movzx eax,byte [eax]
00002842  84C0              test al,al
00002844  75DB              jnz 0x2821
00002846  67660FB745FE      movzx eax,word [ebp-0x2]
0000284C  66C9              o32 leave
0000284E  66C3              retd
00002850  F30F1EFB          endbr32
00002854  6655              push ebp
00002856  6689E5            mov ebp,esp
00002859  6683EC18          sub esp,byte +0x18
0000285D  67668945F4        mov [ebp-0xc],eax
00002862  67668B45F4        mov eax,[ebp-0xc]
00002867  66E811000000      call dword 0x287e
0000286D  66B887A50000      mov eax,0xa587
00002873  66E805000000      call dword 0x287e
00002879  90                nop
0000287A  66C9              o32 leave
0000287C  66C3              retd
0000287E  F30F1EFB          endbr32
00002882  6655              push ebp
00002884  6689E5            mov ebp,esp
00002887  6683EC14          sub esp,byte +0x14
0000288B  67668945EC        mov [ebp-0x14],eax
00002890  67C745FE0000      mov word [ebp-0x2],0x0
00002896  EB2B              jmp short 0x28c3
00002898  67660FB755FE      movzx edx,word [ebp-0x2]
0000289E  67668B45EC        mov eax,[ebp-0x14]
000028A3  6601D0            add eax,edx
000028A6  67660FB600        movzx eax,byte [eax]
000028AB  660FBEC0          movsx eax,al
000028AF  66E83DFEFFFF      call dword 0x26f2
000028B5  67660FB745FE      movzx eax,word [ebp-0x2]
000028BB  6683C001          add eax,byte +0x1
000028BF  678945FE          mov [ebp-0x2],ax
000028C3  67668B45EC        mov eax,[ebp-0x14]
000028C8  66E839FFFFFF      call dword 0x2807
000028CE  673945FE          cmp [ebp-0x2],ax
000028D2  72C4              jc 0x2898
000028D4  90                nop
000028D5  90                nop
000028D6  66C9              o32 leave
000028D8  66C3              retd
000028DA  F30F1EFB          endbr32
000028DE  6655              push ebp
000028E0  6689E5            mov ebp,esp
000028E3  6683EC14          sub esp,byte +0x14
000028E7  678945EC          mov [ebp-0x14],ax
000028EB  67660FB745EC      movzx eax,word [ebp-0x14]
000028F1  6689C2            mov edx,eax
000028F4  EC                in al,dx
000028F5  678845FF          mov [ebp-0x1],al
000028F9  67660FB645FF      movzx eax,byte [ebp-0x1]
000028FF  66C9              o32 leave
00002901  66C3              retd
00002903  F30F1EFB          endbr32
00002907  6655              push ebp
00002909  6689E5            mov ebp,esp
0000290C  6683EC08          sub esp,byte +0x8
00002910  678945FC          mov [ebp-0x4],ax
00002914  6689D0            mov eax,edx
00002917  678845F8          mov [ebp-0x8],al
0000291B  67660FB755FC      movzx edx,word [ebp-0x4]
00002921  67660FB645F8      movzx eax,byte [ebp-0x8]
00002927  EE                out dx,al
00002928  90                nop
00002929  66C9              o32 leave
0000292B  66C3              retd
0000292D  F30F1EFB          endbr32
00002931  6655              push ebp
00002933  6689E5            mov ebp,esp
00002936  6683EC18          sub esp,byte +0x18
0000293A  66E886FBFFFF      call dword 0x24c6
00002940  6766C745F489A500  mov dword [ebp-0xc],0xa589
         -00
00002949  66B861000000      mov eax,0x61
0000294F  66E89DFDFFFF      call dword 0x26f2
00002955  66B864000000      mov eax,0x64
0000295B  66E891FDFFFF      call dword 0x26f2
00002961  67668B45F4        mov eax,[ebp-0xc]
00002966  6683C001          add eax,byte +0x1
0000296A  67660FB600        movzx eax,byte [eax]
0000296F  660FBEC0          movsx eax,al
00002973  66E879FDFFFF      call dword 0x26f2
00002979  66B889A50000      mov eax,0xa589
0000297F  66E8F9FEFFFF      call dword 0x287e
00002985  EBFE              jmp short 0x2985
00002987  0A00              or al,[bx+si]
00002989  48                dec ax
0000298A  656C              gs insb
0000298C  6C                insb
0000298D  6F                outsw
0000298E  206672            and [bp+0x72],ah
00002991  6F                outsw
00002992  6D                insw
00002993  204321            and [bp+di+0x21],al
00002996  0000              add [bx+si],al
00002998  47                inc di
00002999  43                inc bx
0000299A  43                inc bx
0000299B  3A20              cmp ah,[bx+si]
0000299D  285562            sub [di+0x62],dl
000029A0  756E              jnz 0x2a10
000029A2  7475              jz 0x2a19
000029A4  2039              and [bx+di],bh
000029A6  2E332E302D        xor bp,[cs:0x2d30]
000029AB  3137              xor [bx],si
000029AD  7562              jnz 0x2a11
000029AF  756E              jnz 0x2a1f
000029B1  7475              jz 0x2a28
000029B3  317E32            xor [bp+0x32],di
000029B6  302E3034          xor [0x3430],ch
000029BA  2920              sub [bx+si],sp
000029BC  392E332E          cmp [0x2e33],bp
000029C0  3000              xor [bx+si],al
000029C2  6690              xchg eax,eax
000029C4  0400              add al,0x0
000029C6  0000              add [bx+si],al
000029C8  0C00              or al,0x0
000029CA  0000              add [bx+si],al
000029CC  050000            add ax,0x0
000029CF  00474E            add [bx+0x4e],al
000029D2  55                push bp
000029D3  0002              add [bp+si],al
000029D5  0000              add [bx+si],al
000029D7  C00400            rol byte [si],byte 0x0
000029DA  0000              add [bx+si],al
000029DC  0300              add ax,[bx+si]
